...
class FreeplayState extends MusicBeatState // REWRITE FREEPLAY!?!?!? HELL YEA!!!!!
{
	...
	override function update(elapsed:Float)
	{
		...
		var upP = FlxG.keys.justPressed.LEFT || FlxG.keys.justPressed.A || controls.LEFT_P;
		var downP = FlxG.keys.justPressed.RIGHT || FlxG.keys.justPressed.D || controls.RIGHT_P;
